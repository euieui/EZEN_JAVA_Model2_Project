...
public class MemberDao {
	...
	public MemberVO confirmPhone(String name, String phone) {
		MemberVO mvo = null;
		con = Dbman.getConnection();
		String sql = "select * from member2 where name=? and phone=?";
	...
	public MemberVO confirmIdnamePhone(String id, String name, String phone) {
		MemberVO mvo = null;
		con = Dbman.getConnection();
		String sql = "select * from member2 where name =? and phone =? and id = ?";
	...
	public void resetPw(MemberVO mvo) {
		con = Dbman.getConnection();
		String sql = "update member2 set pwd=? where id = ?";
		try {
			pstmt = con.prepareStatement(sql);
			pstmt.setString(1, mvo.getPwd());
